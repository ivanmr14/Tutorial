...
import com.ccsw.springboot.author.model.AuthorDto;
import com.ccsw.springboot.category.model.CategoryDto;
...
public class GameIT {
    ...
    private static final Integer TOTAL_GAMES = null;
    ...
    ParameterizedTypeReference<List<GameDto>> responseTypeList = new ParameterizedTypeReference<List<GameDto>>() {
    };

    @Test
    public void findAllShouldReturnAllGame() {

        ResponseEntity<List<GameDto>> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.GET,
